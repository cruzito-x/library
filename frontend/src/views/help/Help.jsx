                      ...
                      items={[
                        {
                          ...
                          children: <>
                          <p>
                            Para generar un reporte los pasos a seguir son los siguientes:
                          </p>
                          <ul>
                            <li>
                              <h3> Paso 1. </h3>
                              <p> Selecciona el período de tiempo del cual deseas exportar la información: </p>
                              <div style={{ textAlign: "center" }}>
                                <Image
                            ...
                            <li>
                              <h3> Paso 2. </h3>
                              <p> Selecciona la ubicación donde deseas guardar el reporte </p>
                              <div style={{ textAlign: "center" }}>
                                <Image
                                  src={saveReport}
                                  preview={false} // Desactiva la previsualización si no es necesaria
                            ...
                            <li>
                              <h3> Paso 3. </h3>
                              <p> El paso 2 te devolverá un archivo descargado con extensión <strong>.pdf</strong> </p>
                              <div style={{ textAlign: "center" }}>
                                <Image
                          ...
                          <p> Si deseas generar otro reporte, sigue los pasos ya mencionados. </p>
                          </>,
                        },
                      ]}
                    />
