...
const DashboardGraphs = ({ period }) => {
  ...
  useEffect(() => {
    ...
    fetch(`http://192.168.0.6:3001/dashboard/totalBooks?period=${period}`)
    ...
    fetch(`http://192.168.0.6:3001/dashboard/totalSales?period=${period}`)
      .then((response) => response.json())
      .then((data) => {
    ...
    fetch(`http://192.168.0.6:3001/dashboard/totalRevenue?period=${period}`)
      .then((response) => response.json())
      .then((data) => {
    ...
    fetch(`http://192.168.0.6:3001/dashboard/totalInvoices?period=${period}`)
      .then((response) => response.json())
      .then((data) => {
  ...
  useEffect(() => {
    setLoading(true);
    fetch(`http://192.168.0.6:3001/dashboard?period=${period}`)
      .then((response) => {
        if (!response.ok) {
  ...
  useEffect(() => {
    setLoading(true);
    fetch(`http://192.168.0.6:3001/dashboard/salesResume?period=${period}`)
      .then((response) => {
        if (!response.ok) {
  ...
  useEffect(() => {
    setLoading(true);
    fetch(`http://192.168.0.6:3001/dashboard/topSellers?period=${period}`)
      .then((response) => {
        if (!response.ok) {
  ...
  useEffect(() => {
    fetch("http://192.168.0.6:3001/dashboard/latest")
      .then((response) => {
        if (!response.ok) {
